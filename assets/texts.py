...
# DIALOG BUTTONS TEXT
DIALOG_BUTTON_TEXT = 'Aceptar'

# DIALOG MESSAGES
DIALOG_INCORRECT_DATA = 'Asegurate de escribir el nombre del archivo y el de la columna a graficar'
DIALOG_INCORRECT_DATA_LINEPLOT = 'Asegurate de escribir el nombre del archivo y los respectivos ejes'
DIALOG_FILE_NOT_FOUND = 'El archivo no se encontró'
